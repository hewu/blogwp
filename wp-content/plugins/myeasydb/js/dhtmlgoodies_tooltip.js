...
Updated:
	March, 11th, 2006 - Fixed positioning of tooltip when displayed near
	the right edge of the browser.

	April, 6th 2006, Using iframe in IE in order to make the tooltip cover
	select boxes.
...
function showTooltip(e,tooltipTxt)
{
	...
	var leftPos = mouseAbsX + 10;
	var topPos = mouseAbsY + 10;
	...
	dhtmlgoodies_tooltipShadow.style.top = topPos + st + dhtmlgoodies_shadowSize + 'px';
	...
	dhtmlgoodies_tooltip.style.width = '50%';
	dhtmlgoodies_tooltipShadow.style.width = '50%';
