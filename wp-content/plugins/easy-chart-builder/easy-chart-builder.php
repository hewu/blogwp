...
'DEF_COLORS_2', 'DEF_COLORS_3', 'DEF_COLORS_4', 'DEF_COLORS_5', 'DEF_COLORS_6', 'DEF_COLORS_7', 'DEF_COLORS_8', 'DEF_COLORS_9', 'DEF_COLORS_10', 'DEF_COLORS_11', 'DEF_COLORS_12',
		);
	...
	{  
	    ...
	    if ($chartConfig['hidechartdata'] == false)
	        $dataShow = "<br/><br/><INPUT type='button' value='Show/Hide Table Data' onclick='wpEasyChartToggle("
	        .$tableDiv
