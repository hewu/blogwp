...
<tr><th scope="row"><?php _e("Grids Columns", "gd-press-tools"); ?></th>
    <td>
        ...
        <br />
        <input type="checkbox" name="integrate_cat_id" id="integrate_cat_id"<?php if ($options["integrate_cat_id"] == 1) echo " checked"; ?> /><label style="margin-left: 5px;" for="integrate_cat_id"><?php _e("Add ID column on the post categories edit panel table.", "gd-press-tools"); ?> <strong>[<?php _e("WP 2.8 and higher.", "gd-press-tools"); ?>]</strong></label>
        <br />
        <input type="checkbox" name="integrate_tag_id" id="integrate_tag_id"<?php if ($options["integrate_tag_id"] == 1) echo " checked"; ?> /><label style="margin-left: 5px;" for="integrate_tag_id"><?php _e("Add ID column on the post tags and custom taxonomies edit panels tables.", "gd-press-tools"); ?> <strong>[<?php _e("WP 2.8 and higher.", "gd-press-tools"); ?>]</strong></label>
        <div class="gdsr-table-split"></div>
        ...
        <div class="gdsr-table-split"></div>
        <input type="checkbox" name="integrate_user_id" id="integrate_user_id"<?php if ($options["integrate_user_id"] == 1) echo " checked"; ?> /><label style="margin-left: 5px;" for="integrate_user_id"><?php _e("Add ID column on the users edit panel table.", "gd-press-tools"); ?> <strong>[<?php _e("WP 2.8 and higher.", "gd-press-tools"); ?>]</strong></label>
        <br />
        <input type="checkbox" name="integrate_user_comments" id="integrate_user_comments"<?php if ($options["integrate_user_comments"] == 1) echo " checked"; ?> /><label style="margin-left: 5px;" for="integrate_user_comments"><?php _e("Add column with comments count on the users edit panel table.", "gd-press-tools"); ?> <strong>[<?php _e("WP 2.8 and higher.", "gd-press-tools"); ?>]</strong></label>
        <br />
        <input type="checkbox" name="integrate_user_display" id="integrate_user_display"<?php if ($options["integrate_user_display"] == 1) echo " checked"; ?> /><label style="margin-left: 5px;" for="integrate_user_display"><?php _e("Add display name column on the users edit panel table.", "gd-press-tools"); ?> <strong>[<?php _e("WP 2.8 and higher.", "gd-press-tools"); ?>]</strong></label>
    </td>
</tr>
<tr><th scope="row"><?php _e("Grids Rows", "gd-press-tools"); ?></th>
    <td>
        <table cellpadding="0" cellspacing="0" class="previewtable">
            <tr>
                <td width="400"><?php _e("Number of posts in grid on edit posts panel", "gd-press-tools"); ?>:</td>
                <td><input type="text" name="integrate_post_per_page" id="integrate_post_per_page" value="<?php echo $options["integrate_post_per_page"]; ?>" style="width: 100px; text-align: right" /></td>
            </tr>
        </table>
        <div class="gdsr-table-split"></div>
        <?php _e("Enter 0 or less to disable modification.", "gd-press-tools"); ?> <strong>[<?php _e("WP 2.8", "gd-press-tools"); ?>]</strong>
    </td>
</tr>
