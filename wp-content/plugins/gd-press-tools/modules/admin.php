...
<tr><th scope="row"><?php _e("Folder Protection", "gd-press-tools"); ?></th>
    <td>
        <form method="post">
        <?php echo sprintf(__("Add %s file with redirection to a home page as a mean of protection agains direct access to some folders. File will be added to following folders if needed:", "gd-press-tools"), "<strong>index</strong>"); ?><br />
