...
[Upgrade to GD Press Tools PRO](http://dv4p.com/gdpt) |
[Compare Lite VS PRO](http://dv4p.com/ve)
...
Lite version has partial support for the multi site installations. Allowing access to plugins Database options is not reccomended for individual blogs, and SiteAdmin should disable this on the plugins General Settings tab. If you need full support for Multisite installations, upgrade plugin to PRO version.
